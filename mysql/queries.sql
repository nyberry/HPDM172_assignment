...
-- 15 query for doctor with the most prescriptions
...
-- 16 use this query to fetch doctors at the hospital with the largest number of beds
...
-- 17 this query prints hospitals accredited before 2015 that have an emergency department
...
-- 18 this query returns patients whose doctors work at hospitals with fewer than 400 beds.
...
-- 19 this query prints all lab results from hospitals accredited between 2013&2020
